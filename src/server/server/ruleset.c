				    ...
				    const char *name, const char *extension)
{
  ...
  my_snprintf(filename, sizeof(filename), "data/%s/%s.%s", subdir, name, extension);
  return filename; //[SB] 14-11-2010

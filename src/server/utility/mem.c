		     ...
		     const char *called_as, int line, const char *file)
{
	...
	// remember_allocation_if_in_watch_mode (ptr, line, file);
	return ptr;
}
		      ...
		      const char *called_as, int line, const char *file)
{
	...
	*/
	...
	// change_allocation_if_in_watch_mode (ptr, new_ptr, line, file);
	return new_ptr;
}
...
{
	// forget_allocation_if_in_watch_mode (_pMem);
	free (_pMem);
}

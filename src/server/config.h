...
#define FC_STORE_CFLAGS '-Wall -Wpointer-arith -Wcast-align -Wmissing-prototypes -Wmissing-declarations -g -O2 -fsigned-char'
...
/*#define HAVE_LIBBZ2 1 [SB]*/
#undef HAVE_LIBBZ2 /*[SB]*/
...
#define NEXT_STABLE_VERSION "2.2.1"

...
**************************************************************************/
void popup_revolution_dialog_original(void)
{
  /* PORTME */
}
...
/**************************************************************************
  ...
  a city (other than its home city).  Example:
    ...
    - Keep moving.
**************************************************************************/
void popup_caravan_dialog_original(struct unit *punit,
...
/**************************************************************************
  ...
  pillage.
**************************************************************************/
void popup_pillage_dialog_original(struct unit *punit, bv_special may_pillage,
                          bv_bases bases)
{
  /* PORTME */
}

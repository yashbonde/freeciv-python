...
void popup_caravan_dialog_original(struct unit *punit, struct city *phomecity, struct city *pdestcity);
bool caravan_dialog_is_open(int* unit_id, int* city_id);
void caravan_dialog_update(void);

void popup_diplomat_dialog(struct unit *punit, struct tile *ptile);
void popup_diplomat_dialog_original(struct unit *punit, struct tile *ptile);
...
void popup_incite_dialog_original(struct city *pcity, int cost);
void popup_bribe_dialog(struct unit *punit, int cost);
void popup_bribe_dialog_original(struct unit *punit, int cost);
void popup_sabotage_dialog(struct city *pcity);
void popup_sabotage_dialog_original(struct city *pcity);
void popup_pillage_dialog(struct unit *punit, bv_special may_pillage, bv_bases bases);
void popup_pillage_dialog_original(struct unit *punit, bv_special may_pillage, bv_bases bases);

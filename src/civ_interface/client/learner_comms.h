...
#define LCP_CONNECT_INTERNAL	"in"
#define LCP_DISCONNECT_INTERNAL	"id"
#define LCP_LOADGAME_INTERNAL	"il"
#define LCP_SEND_WONLOST		"iw"
...
#define LCP_TERMINATOR_CHAR		'\x05'
